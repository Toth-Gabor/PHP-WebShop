...
?>
    <div class="account-wall">
        <form action='check_out.php' method='post' id='guest_details'>
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-plus-square"></i> Order
                        </button>
                    </td>
                </tr>
...
if ($_POST) {
    ...
    if ($user_srv->CheckEmailExists($email)) {
        ...
        $user_srv->AddUser($firstname, $lastname, $email, $contact_number, $address,
            $password, $access_level, null, $user_srv, $created_at);
        $isItCreated = true;
        $user_id = $user_srv->ReadUserByEmail($email)->getId();
